...
class ResourceQuota(BaseModel):
    ...
    # API limits
    api_requests_per_minute: Optional[int] = Field(None, description="API requests per minute")
    api_requests_per_day: Optional[int] = Field(None, description="API requests per day")
    
    # Agent limits
    max_agents: Optional[int] = Field(None, description="Maximum number of agents")
    max_workflows: Optional[int] = Field(None, description="Maximum number of workflows")
    max_executions_per_day: Optional[int] = Field(None, description="Max workflow executions per day")
...
class Tenant(BaseModel):
    ...
    status: TenantStatus = Field(default=TenantStatus.TRIAL, description="Tenant status")
    ...
    config: TenantConfiguration = Field(
        default_factory=TenantConfiguration,
...
class TenantBilling(BaseModel):
    ...
    usage_charges: Dict[str, float] = Field(
        default_factory=dict,
        description="Usage-based charges by resource type"
    )
