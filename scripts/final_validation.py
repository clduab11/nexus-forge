...
class ValidationResult:
    def __init__(
        self, name: str, status: bool, message: str, details: Optional[Dict] = None
    ):
        self.name = name
        self.status = status
...
class NexusForgeValidator:
    ...
    def validate_core_imports(self) -> ValidationResult:
        ...
        try:
            ...
            from nexus_forge.core.exceptions import AgentError, NexusForgeError
    ...
    def validate_security_setup(self) -> ValidationResult:
        ...
        try:
            ...
            from nexus_forge.api.dependencies.auth import (
                create_access_token,
                get_current_user,
            )
    ...
    def validate_frontend_setup(self) -> ValidationResult:
        ...
        frontend_items = {
            ...
            "main_component": os.path.exists(
                "frontend/src/components/NexusForgeWorkspace.tsx"
            ),
