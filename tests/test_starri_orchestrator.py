...
class TestStarriOrchestrator:
    ...
    async def sample_app_spec(self):
        ...
        return AppSpecification(
            ...
            api_endpoints=[
                ...
                {"method": "POST", "path": "/api/auth", "description": "Authentication"}
            ],
            database_schema={
                "tables": ["users", "analytics", "sessions"]
            },
            deployment_config={
                "platform": "Cloud Run",
                "scaling": "auto"
    ...
    async def test_starri_analyze_and_plan(self, orchestrator):
        ...
        user_prompt = "Build a real-time analytics dashboard with charts and user authentication"
    ...
    async def test_error_handling_and_recovery(self, orchestrator):
        ...
        with patch('nexus_forge.agents.agents.nexus_forge_agents.logger') as mock_logger:
            try:
    ...
    async def test_build_app_with_starri_full_workflow(self, orchestrator, sample_app_spec):
    ...
    async def test_agent_status_tracking(self, orchestrator, sample_app_spec):
        ...
        # Set up mocks
        orchestrator.generate_app_specification = AsyncMock(return_value=sample_app_spec)
