...
from nexus_forge.core.exceptions import CoordinationError, AgentError
...
class SupabaseCoordinationClient:
    ...
    async def update_agent_state(
        ...
        try:
            ...
            await self._broadcast_event('agent_status', {
                'agent_id': agent_id,
                'status': status,
                'payload': payload,
    ...
    async def get_agent_state(self, agent_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            result = self.client.table('agent_states').select('*').eq(
                'agent_id', agent_id
    ...
    async def update_workflow_status(
        ...
        try:
            ...
            await self._broadcast_event('workflow_progress', {
                'workflow_id': workflow_id,
                'status': status,
                'timestamp': datetime.now(timezone.utc).isoformat(),
                'metrics': metrics
    ...
    async def create_task(
        ...
        try:
            ...
            await self._broadcast_event('task_updates', {
                'task_id': task_id,
                'workflow_id': workflow_id,
                'status': 'pending',
                'agent_id': agent_id,
    ...
    async def assign_task(self, task_id: str, agent_id: str) -> bool:
        ...
        try:
            ...
            # Update agent state
            await self.update_agent_state(agent_id, 'busy', {
