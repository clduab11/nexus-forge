...
class HealthChecker:
    ...
    async def _run_health_check(self, name: str, check_func) -> HealthCheckResult:
        ...
        try:
            ...
            api_logger.log_health_check(name, name, status == "healthy", latency_ms / 1000)
    ...
    def _determine_status(self, check_name: str, details: Dict[str, Any], latency_ms: float) -> str:
