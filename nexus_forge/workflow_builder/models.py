...
class NodeConfig(BaseModel):
    ...
    condition: Optional[str] = Field(None, description="JavaScript condition expression")
    
    # Error handling
    continue_on_error: bool = Field(default=False, description="Continue workflow on error")
    error_path: Optional[str] = Field(None, description="Path to take on error")
    
    # Node-specific configuration
    settings: Dict[str, Any] = Field(default_factory=dict, description="Node-specific settings")
...
class WorkflowConnection(BaseModel):
    ...
    type: ConnectionType = Field(default=ConnectionType.DEFAULT, description="Connection type")
...
class Workflow(BaseModel):
    ...
    # Configuration
    variables: List[WorkflowVariable] = Field(default_factory=list, description="Global variables")
...
class WorkflowExecution(BaseModel):
    ...
    variables: Dict[str, Any] = Field(
        default_factory=dict,
        description="Runtime variable values"
    )
