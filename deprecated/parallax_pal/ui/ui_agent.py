...
class UIAgent(Agent):
    ...
    def create_ui_components(self, request: Dict) -> Dict:
        ...
        try:
            ...
            self.logger.info(
                f"Creating UI components for request type: {request_type}, request_id: {request_id}"
            )
    ...
    def _create_research_ui(self, content: Dict) -> Dict:
        ...
        try:
            ...
            # Create animations
            animations = [
                {"character": "assistant", "emotion": emotion, "animation": animation}
            ]

            return {
                "request_id": content.get("research", {}).get(
    ...
    def _create_knowledge_graph_ui(self, content: Dict) -> Dict:
        ...
        try:
            ...
            # Create animations
            animations = [
                {"character": "assistant", "emotion": emotion, "animation": "pointing"}
            ]
    ...
    def _create_error_ui(self, content: Dict) -> Dict:
        ...
        try:
            ...
            # Create animations
            animations = [
                {"character": "assistant", "emotion": "sad", "animation": "apologizing"}
            ]
    ...
    def _create_welcome_ui(self, content: Dict) -> Dict:
        ...
        try:
            ...
            # Create animations
            animations = [
                {"character": "assistant", "emotion": "happy", "animation": "waving"}
            ]
    ...
    def _create_default_ui(self, content: Dict) -> Dict:
        ...
        """
        # Create UI elements
        ui_elements = {"component": "default_view", "props": {"content": content}}

        # Create animations
        animations = [
            {"character": "assistant", "emotion": "neutral", "animation": "idle"}
        ]
    ...
    def generate_animation(self, emotion: str, context: Dict) -> Dict:
        ...
        animation = next(
            (a for a in preferred_animations if a in available_animations),
