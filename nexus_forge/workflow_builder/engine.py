...
from .models import (
    Workflow, WorkflowNode, WorkflowExecution, WorkflowTemplate,
    ExecutionStatus, NodeType
)
from .compiler import WorkflowCompiler, CompiledWorkflow
...
class WorkflowEngine:
            ...
            "ai_agent": {
                ...
                "config_schema": {
                    ...
                    "properties": {
                        "agent_type": {
                            "type": "string",
                            "enum": ["text_generation", "data_analysis", "code_generation"],
    ...
    async def get_workflow(self, workflow_id: str) -> Workflow:
        ...
        # Query database
        result = await self.supabase.client.table("workflows") \
            .select("*") \
            .eq("id", workflow_id) \
            .execute()
    ...
    async def get_execution(self, execution_id: str) -> Optional[WorkflowExecution]:
        ...
        try:
            result = await self.supabase.client.table("workflow_executions") \
                .select("*") \
                .eq("id", execution_id) \
                .execute()
    ...
    async def list_executions(
        ...
        query = self.supabase.client.table("workflow_executions") \
            .select("*")
    ...
    async def get_template(self, template_id: str) -> WorkflowTemplate:
        ...
        result = await self.supabase.client.table("workflow_templates") \
            .select("*") \
            .eq("id", template_id) \
            .execute()
    ...
    async def list_templates(
        ...
        query = self.supabase.client.table("workflow_templates") \
            .select("*") \
            .eq("published", True)
    ...
    async def get_workflow_stats(self, workflow_id: str) -> Dict[str, Any]:
        ...
        # Get execution stats
        exec_query = self.supabase.client.table("workflow_executions") \
        ...
        for status in ExecutionStatus:
            count_query = self.supabase.client.table("workflow_executions") \
    ...
    async def _save_workflow(self, workflow: Workflow):
        ...
        await self.supabase.client.table("workflows").insert(
            workflow.dict()
        ).execute()
