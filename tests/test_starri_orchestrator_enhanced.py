...
class TestStarriOrchestratorEnhanced:
    ...
    async def test_deep_thinking_analysis_mode(self, orchestrator):
        ...
        assert call_args[1]["model_type"] == "flash"  # Should use flash model for thinking
    ...
    async def test_task_decomposition_with_thinking(self, orchestrator):
        ...
        orchestrator.think_deeply = AsyncMock(
            return_value={
                "thinking_chain": [
                    {"step": 1, "thought": "Analyzing requirements...", "confidence": 0.8},
                    {"step": 2, "thought": "Breaking into subtasks...", "confidence": 0.9}
                ],
                "conclusion": {
                    "conclusion": """
    ...
    async def test_agent_registration_with_knowledge_graph(self, orchestrator):
        ...
        assert agent_id in orchestrator.agent_capabilities[AgentCapability.CODE_GENERATION]
    ...
    async def test_confidence_extraction_from_thinking(self, orchestrator):
        ...
        confidence = orchestrator._extract_confidence("I am 85% confident in this solution")
        ...
        confidence = orchestrator._extract_confidence("I am certain this is the correct approach")
        assert confidence == 0.9
        
        # Test uncertain words
        confidence = orchestrator._extract_confidence("This might possibly work, but I'm uncertain")
