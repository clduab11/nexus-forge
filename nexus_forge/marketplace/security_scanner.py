...
from .models import SecurityReport, AgentPackage
...
class SecurityScanner:
    ...
    async def scan_package(self, package_path: str) -> SecurityReport:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Process results
            code_issues, dep_issues, malware_found, perm_issues, manifest_issues = results
        ...
        if req_file.exists():
            ...
            for req in requirements:
                ...
                if package_name in self.vulnerability_db.get("vulnerable_packages", {}):
                    vuln_info = self.vulnerability_db["vulnerable_packages"][package_name]
    ...
    async def _scan_for_malware(self, path: str) -> bool:
        ...
        for file_path in Path(path).rglob("*"):
            if file_path.is_file():
                ...
                if file_hash in self.vulnerability_db.get("known_malware_hashes", set()):
                    return True
    ...
    def _calculate_risk_score(self, report: SecurityReport) -> float:
        ...
        medium_vulns = [v for v in report.vulnerabilities if v.get("severity") == "medium"]
